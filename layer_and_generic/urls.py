...
urlpatterns = [
    # Auth
    path("home_layer_and_generic", HomeView.as_view(), name="home_layer_and_generic"),
    path(
        "register_layer_and_generic/",
        RegisterView.as_view(),
        name="register_layer_and_generic",
    ),
    path(
        "login_layer_and_generic/", LoginView.as_view(), name="login_layer_and_generic"
    ),
    path(
        "logout_layer_and_generic/",
        LogoutView.as_view(),
        name="logout_layer_and_generic",
    ),
    # Table1
